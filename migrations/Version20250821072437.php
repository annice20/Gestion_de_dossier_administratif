 ...
 */
final class Version20250821072437 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE signature (id INT AUTO_INCREMENT NOT NULL, decision_id_id INT NOT NULL, type VARCHAR(20) NOT NULL, scelle VARCHAR(100) NOT NULL, horodatage DATETIME NOT NULL, UNIQUE INDEX UNIQ_AE8801415801595E (decision_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE signature ADD CONSTRAINT FK_AE8801415801595E FOREIGN KEY (decision_id_id) REFERENCES decision (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE signature DROP FOREIGN KEY FK_AE8801415801595E');
